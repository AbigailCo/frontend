      ...
      {showModal && (
        ...
        >
          <h1 className="text-lg text-green-600">
            Su turno quedo pendiente a confirmacion
          </h1>
          <p className="text-sm">
            <span className="font-medium">{user.name} :</span> en cuanto
            aprueben tu solicitud recibiras un correo con la aprobacion
          </p>
          <p className="text-sm">Informacion de contacto: {user.email}</p>
          <div
            className="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-800 rounded-lg bg-yellow-50 dark:bg-yellow-200 dark:text-yellow-800 dark:border-yellow-800"
            role="alert"
          >
            <svg
            ...
            <div>
              <span className="font-medium">Segui tus solicitudes</span> Podes
              mirar el estado de tus solicitudes en el area 'Solicitudes'.
            </div>
          </div>
        </C.Modal>
      )}
